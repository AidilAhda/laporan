...
/**
 * This is the ActiveQuery class for [[PendaftaranMDebitur]].
 *
 * @see PendaftaranMDebitur
 */
class PendaftaranMDebiturQuery extends \yii\db\ActiveQuery
{
    ...
    /**
     * {@inheritdoc}
     * @return PendaftaranMDebitur[]|array
     */
    ...
    /**
     * {@inheritdoc}
     * @return PendaftaranMDebitur|array|null
     */
