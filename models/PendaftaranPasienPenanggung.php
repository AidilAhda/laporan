...
use Yii;
class PendaftaranPasienPenanggung extends \yii\db\ActiveRecord
{
    ...
    function savePasienLuarPenanggung($obj)
    {
        Yii::$app->db->createCommand()->delete(self::tableName(),['pen_pasien_kode'=>$obj->psl_kode])->execute();
