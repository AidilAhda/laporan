...
<h3 align="center">LAPORAN PEMAKAIAN OBAT
    <?= $dokterf ? $dokterf['pgw_gelar_depan'].' '.$dokterf['pgw_nama'].' '.$dokterf['pgw_gelar_belakang'] : 'OLEH DOKTER' ?>
    <br>
...
<table width="100%" border="1" cellspacing="0" style="text-align: center;vertical-align: middle;">
    ...
    <tr>
        <td><?= $no++ ?></td>
        <td><?= $val['dokter']? $val['pnj_nama_dokter'] : ''?></td>
